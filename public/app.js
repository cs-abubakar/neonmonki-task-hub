  ...
  <div class="card report-card" id="report-card">
    ...
    <div class="report-body">
      ...
      ${!st.reportLoading && !st.reportError && r ? `
        <div class="ai-label">${I.sparkle} AI-generated by Monki${(r.ts || r.generatedAt) ? ` · ${timeAgo(r.ts || r.generatedAt)}` : ""}${reportPeriodLabel(r) ? ` · ${esc(reportPeriodLabel(r))} report` : ""} — review before sharing</div>
  ...
  return `<div class="monki-message assistant">
    ...
    <div class="monki-message-body">
      ...
      <div class="monki-bubble assistant-bubble ${a.error ? "error" : ""} ${a.report ? "report-bubble" : ""}">
        ${a.report ? `<div class="ai-label monki-report-label">${I.sparkle} AI-generated report — review before sharing</div>` : ""}

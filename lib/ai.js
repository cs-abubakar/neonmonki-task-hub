...
async function runAsk(store, user, question, { channelId, channelName, allowedTools, deep, lastVisit, reportingContext } = {}) {
  ...
  // Tiered reporting access: "full" gets the owner-grade digest, "basic" the
  // calm client-safe one, "none" no digest at all. The tool allowlist below
  // still keys off `smartReporting` exactly as before.

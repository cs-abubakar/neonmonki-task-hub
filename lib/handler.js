...
const { memberOf, canAccessChannel, accessibleChannels, canSeeTask, visibleTasks } = require("./permissions");
const ai = require("./ai");
...
async function route(req, res, key, parts) {
  ...
  switch (key) {
    ...
    case "GET /api/state": {
      ...
      return send(res, 200, { ...state, tasks, activity, meta: { statuses: STATUSES, priorities: PRIORITIES } });
    }
